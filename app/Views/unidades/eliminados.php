                ...
                <tbody>
                    ...
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="#" data-href="<?php echo base_url() . 'unidades/reingresar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Reingresar registro" class="btn btn-warning">
