<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div>
                <p>
                    <a href="<?php echo base_url(); ?>categoriaPermisos/nuevo" class="btn btn-info">Agregar</a>
                    <a href="<?php echo base_url(); ?>categoriaPermisos/eliminados" class="btn btn-warning">Eliminados</a>
                </p>
                ...
                <tbody>
                    ...
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url() . 'categoriaPermisos/editar/' . $dato['id']; ?>" class="btn btn-warning">
                                    <i class="fa-solid fa-pencil"></i></a></td>
                            <!--Vamos a trabajar Modal con el evento eliminar  -->
                            
                            <td>
                                <a href="#" data-href="<?php echo base_url() . 'categoriaPermisos/eliminar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma"
