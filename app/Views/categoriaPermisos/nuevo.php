<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <form method="POST" action="<?php echo base_url(); ?>categoriaPermisos/insertar" autocomplete="off">
                 <div class="form-group">
                    ...
                    <br>
                    <a href="<?php echo base_url(); ?>categoriaPermisos" class="btn btn-primary">Regresar</a>
