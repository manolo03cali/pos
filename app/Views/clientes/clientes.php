                ...
                <tbody>
                    ...
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url() . 'clientes/editar/' . $dato['id']; ?>" class="btn btn-warning">
                                    <i class="fa-solid fa-pencil"></i></a></td>
                            <!--Vamos a trabajar Modal con el evento eliminar  -->
                            
                            <td>
                                <a href="#" data-href="<?php echo base_url() . 'clientes/eliminar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma"
