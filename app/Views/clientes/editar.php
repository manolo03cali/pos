                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <br>
                            <!-- Traemos el dato correspondiente al campo del arreglo datos que viene del controlador-->
                            <input class="=form-control" id="telefono" name="telefono" type="text" value="<?php echo $datos['telefono'] ?>" autofocus  />
                        </div>
                        <div class="col-12 col-sm-6">
                            <label>Correo electronico</label>
                            <br>
                            <input class="=form-control" id="correo" name="correo" type="text" value="<?php echo $datos['correo'] ?>"  />
                        </div>
                    </div>
                </div>
                <br>
