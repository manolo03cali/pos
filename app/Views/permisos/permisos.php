<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div>
                <p>
                    <a href="<?php echo base_url(); ?>permisos/nuevo" class="btn btn-info">Agregar</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url() . 'permisos/editar/' . $dato['id']; ?>" class="btn btn-warning">
                                    <i class="fa-solid fa-pencil"></i></a></td>
                            <!--Vamos a trabajar Modal con el evento eliminar  -->
                            
                            <td>
                                <a href="#" data-href="<?php echo base_url() . 'permisos/eliminar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma"
