que<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <form method="POST" action="<?php echo base_url(); ?>permisos/actualizar" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <label>Tipo</label>
                            <!-- Traemos el dato correspondiente al campo del arreglo datos que viene del controlador-->
                            <input class="=form-control" id="tipo" name="tipo" type="text" value="<?php echo $datos['tipo'] ?>" />
                        </div>
                        <div class="col-12 col-sm-6">
