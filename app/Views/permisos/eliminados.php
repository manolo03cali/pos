<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div>
                <p>
                    <a href="<?php echo base_url(); ?>permisos" class="btn btn-warning">Permisos</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="#" data-href="<?php echo base_url() . 'permisos/reingresar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Reingresar registro" class="btn btn-warning">
