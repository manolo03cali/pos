                ...
                <tbody>
                    ...
                    <?php foreach ($datos as $dato) { ?>
                        <tr>
                            ...
                            <td> <?php echo $dato['cajas_id']; ?></td>
                            <td> <?php echo $dato['roles_id']; ?></td>
                            <td>
                                <a href="#" data-href="<?php echo base_url() . 'usuarios/reingresar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Reingresar registro" class="btn btn-warning">
