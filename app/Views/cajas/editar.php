                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input class="=form-control" id="numero_caja" name="numero_caja" type="text" value="<?php echo $datos['numero_caja'] ?>" autofocus  />
                        </div>
                        <div class="col-12 col-sm-6">
                            <label>Nombre</label>
                            <br>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <br>
                            <!-- Traemos el dato correspondiente al campo del arreglo datos que viene del controlador-->
                            <input class="=form-control" id="folio" name="folio" type="text" value="<?php echo $datos['folio'] ?>" autofocus  />
                        </div>
                    </div>
                </div>
                <br>
