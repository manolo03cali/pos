        ...
        <tbody>
          ...
          <?php foreach ($datos as $dato) { ?>
            <tr>
              ...
              <td> <a href="<?php echo base_url() . 'cajas/arqueo/' . $dato['id']; ?>" class="btn btn-primary">
              <i class="fa-solid fa-clipboard-list"></i></a></td>
                 
              <td> <a href="<?php echo base_url() . 'cajas/editar/' . $dato['id']; ?>" class="btn btn-warning">
                  <i class="fa-solid fa-pencil"></i></a></td>
              <!--Vamos a trabajar Modal con el evento eliminar  -->

              <td>
                <a href="#" data-href="<?php echo base_url() . 'cajas/eliminar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma"
