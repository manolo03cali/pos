                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <br>
                            <input class="=form-control" id="monto_inicial" name="monto_inicial" type="text" value="<?php echo set_value('monto_inicial') ?>" />
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <br>
                            <input class="=form-control" id="folio" name="folio" type="text" value="<?php echo  $caja['folio'] ?>" />
                        </div>
                        <div class="col-12 col-sm-6">
                            <br>
                            <label>Fecha</label>
